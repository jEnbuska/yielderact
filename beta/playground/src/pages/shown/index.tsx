...
export function* ShownDemo() {
  ...
  return (
    <>
      <BreadCrumbs label="Location" hint="/shown">
        <Crumb>yract-beta</Crumb>
        <Crumb>shown prop</Crumb>
      </BreadCrumbs>
      <Window labelledBy={titleId}>
        <WindowBar title="shown prop" titleId={titleId} aside="/shown" />
        <WindowBody>
          <h2>
          ...
          <p>
            ...
            component. When <code>shown</code> changes to <code>false</code> the node is fully
            removed from the DOM (and its state is discarded); setting it back to <code>true</code>{" "}
