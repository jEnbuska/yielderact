 ...
 * across reorders.
 */
import { $id, useEffect, useRef, useState } from "yract-beta";
...
export function* KeyShuffleDemo() {
  ...
  return (
    <>
      <BreadCrumbs label="Location" hint="/key-shuffle">
        <Crumb>yract-beta</Crumb>
        <Crumb>Key Shuffle</Crumb>
      </BreadCrumbs>
      <Window labelledBy={titleId}>
        <WindowBar title="Key Shuffle" titleId={titleId} aside="/key-shuffle" />
        <WindowBody>
          <p>
            Keyed reconciliation moves DOM nodes instead of recreating them. Component state
