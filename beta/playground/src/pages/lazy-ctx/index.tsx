...
export function* LazyContextDemo() {
  ...
  return (
    <>
      <BreadCrumbs label="Location" hint="/lazy-ctx">
        <Crumb>yract-beta</Crumb>
        <Crumb>Lazy Context</Crumb>
      </BreadCrumbs>
      <Window labelledBy={titleId}>
        <WindowBar title="Lazy Context" titleId={titleId} aside="/lazy-ctx" />
        <WindowBody>
          <p style={{ fontSize: "0.875rem", color: "#555", marginBottom: "0.75rem" }}>
            ...
            rendered. Use the buttons to change only <code>count</code> or only{" "}
            <code>user.name</code> and observe which consumers rerender.
          </p>
