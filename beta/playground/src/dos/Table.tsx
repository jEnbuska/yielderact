 ...
 *
 * Pass `rowHeight` to opt body rows into `content-visibility: auto`. It feeds
 * `contain-intrinsic-size`, so give the height a real row measures at —
 * a wrong value makes the scrollbar jump as rows are rendered.
 *
